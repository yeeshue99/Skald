...
posts.push(P("p3", "npc_pell", `skewers two for a copper at Quinn Market, char's proper today. queue's out the door with the demo crowds in town. forming an orderly line is, turns out, NOT a Blackthorn skill. come hungry. come patient. 🍢`, "-11d18h", ["pc_kirill", "pc_val", "npc_cassimir", "pc_calanthe"]));
posts.push(P("p6", "pc_kirill", `Big day. Buttercup (cow) saw her first city. She was very brave. A heron rode on her back for a whole mile and I think they're friends now. Be gentle with the small things, even when the small thing is a very large cow. 🐄`, "-11d10h", ["pc_calanthe", "pc_vesperae", "npc_pell", "pc_spadae", "pc_val"]));
...
posts.push(P("p23", "npc_herald", `PROCLAMATION. The strategic innovation has a name: the Tactical Aether-Golem. It NEVER makes a wrong call. Public demo in 7 days, Blood-Sand, Lord @Lord_Blackthorn presiding. The future does not guess. The future does not grieve. The future has excellent posture. 🌹 #Blackthorn`, "-9d12h", ["npc_briar", "npc_nettle", "npc_lord"]));
...
posts.push(P("p53", "pc_kirill", `Buttercup update: she has been invited to the Aether-Golem demonstration. By a child. Who drew her an invitation. It says "deer cow your art is good". We are going. She is wearing a flower. This is the best day. 🐄🌸`, "-4d12h", ["pc_calanthe", "pc_vesperae", "pc_dez", "npc_pell", "pc_val", "pc_spadae", "npc_lord"]));
